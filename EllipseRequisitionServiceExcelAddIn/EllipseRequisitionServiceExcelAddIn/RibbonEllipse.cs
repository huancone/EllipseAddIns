...
namespace EllipseRequisitionServiceExcelAddIn
{
    public partial class RibbonEllipse
    {
        ...
        private const int ResultColumn02 = 21;
        ...
        private void RequisitionServiceFormat()
        {
            try
            {
                ...
                _cells.GetCell(1, TitleRow01).Value = "Requested By";
                _cells.GetCell(1, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(2, TitleRow01).Value = "Requested By Position";
                _cells.GetCell(2, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleOptional);
                _cells.GetCell(3, TitleRow01).Value = "Indicador de Serie";
                _cells.GetCell(3, TitleRow01).AddComment("Indica una serie diferente para vales con encabezados comunes (Ej. Flota, número, secuencia A, etc)");
                _cells.GetCell(3, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleInformation);
                _cells.GetCell(4, TitleRow01).Value = "Requisition Number";
                _cells.GetCell(4, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleInformation);
                _cells.GetCell(5, TitleRow01).Value = "Requisition Type";
                _cells.GetCell(5, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                ...
                _cells.SetValidationList(_cells.GetCell(5, TitleRow01 + 1), optionReqTypeList, ValidationSheet, 1, false);
                _cells.GetCell(6, TitleRow01).Value = "Transaction Type";
                ...
                _cells.SetValidationList(_cells.GetCell(6, TitleRow01 + 1), optionTransTypeList, ValidationSheet, 2, false);
                _cells.GetCell(7, TitleRow01).Value = "Required By Date";
                _cells.GetCell(7, TitleRow01).AddComment("YYYYMMDD");
                _cells.GetCell(7, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(8, TitleRow01).Value = "Original Warehouse";
                _cells.GetCell(8, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(9, TitleRow01).Value = "Priority Code";
                _cells.GetCell(9, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleRequired);

                var itemList = _eFunctions.GetItemCodes("PI");
                var optionPriorList = MyUtilities.GetCodeList(itemList);
                _cells.SetValidationList(_cells.GetCell(9, TitleRow01 + 1), optionPriorList, ValidationSheet, 3, false);

                _cells.GetCell(10, TitleRow01).Value = "Reference Type";
                _cells.GetCell(10, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                var optionRefTypeList = new List<string> {"Work Order", "Equipment No.", "Project No.", "Account Code"};
                _cells.SetValidationList(_cells.GetCell(10, TitleRow01 + 1), optionRefTypeList, ValidationSheet, 4);

                _cells.GetCell(11, TitleRow01).Value = "Reference";
                _cells.GetCell(11, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleRequired);

                _cells.GetCell(12, TitleRow01).Value = "Delivery Instructions"; //120 caracteres (60/60)
                _cells.GetCell(12, TitleRow01).AddComment("120 caracteres");
                _cells.GetCell(12, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(13, TitleRow01).Value = "Return Cause";
                _cells.GetCell(13, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleOptional);
                _cells.GetCell(14, TitleRow01).Value = "Issue Question";
                _cells.GetCell(14, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleOptional);

                var optionIssueList = new List<string> {"A - VENTAS", "B - RUBROS"};
                _cells.SetValidationList(_cells.GetCell(14, TitleRow01 + 1), optionIssueList, ValidationSheet, 5, false);

                _cells.GetCell(15, TitleRow01).Value = "Partial Allowed";
                ...
                _cells.SetValidationList(_cells.GetCell(15, TitleRow01 + 1), partialAllowedList, ValidationSheet, 5, false);

                _cells.GetCell(16, TitleRow01).Value = "Stock Code";
                _cells.GetCell(16, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(17, TitleRow01).Value = "Unit Of Issue";
                _cells.GetCell(17, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleOptional);
                _cells.GetCell(18, TitleRow01).Value = "Quantity";
                _cells.GetCell(18, TitleRow01).Style = _cells.GetStyle(StyleConstants.TitleRequired);
        ...
        private void RequisitionServiceExtendedFormat()
        {
            try
            {
                ...
                _cells.GetCell(1, TitleRow02).Value = "Requested By";
                _cells.GetCell(1, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(2, TitleRow02).Value = "Requested By Position";
                _cells.GetCell(2, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleOptional);
                _cells.GetCell(3, TitleRow02).Value = "Indicador de Serie";
                _cells.GetCell(3, TitleRow02).AddComment("Indica una serie diferente para vales con encabezados comunes (Ej. Flota, número, secuencia A, etc)");
                _cells.GetCell(3, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleInformation);
                _cells.GetCell(4, TitleRow02).Value = "Requisition Number";
                _cells.GetCell(4, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleInformation);
                _cells.GetCell(5, TitleRow02).Value = "Requisition Type";
                _cells.GetCell(5, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                var optionReqTypeList = new List<string>
                {
                    "NI - NORMAL REQUISITION",
                    "PR - PURCHASE REQUISITION",
                ...
                _cells.SetValidationList(_cells.GetCell(5, TitleRow02 + 1), optionReqTypeList, ValidationSheet, 1, false);
                _cells.GetCell(6, TitleRow02).Value = "Transaction Type";
                _cells.GetCell(6, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                ...
                _cells.SetValidationList(_cells.GetCell(6, TitleRow02 + 1), optionTransTypeList, ValidationSheet, 2, false);
                _cells.GetCell(7, TitleRow02).Value = "Required By Date";
                _cells.GetCell(7, TitleRow02).AddComment("YYYYMMDD");
                _cells.GetCell(7, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(8, TitleRow02).Value = "Original Warehouse";
                _cells.GetCell(8, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(9, TitleRow02).Value = "Priority Code";
                _cells.GetCell(9, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleRequired);

                var itemList = _eFunctions.GetItemCodes("PI");
                var optionPriorList = MyUtilities.GetCodeList(itemList);
                _cells.SetValidationList(_cells.GetCell(9, TitleRow02 + 1), optionPriorList, ValidationSheet, 3, false);

                _cells.GetCell(10, TitleRow02).Value = "Work Order";
                _cells.GetCell(11, TitleRow02).Value = "Equipment No.";
                _cells.GetCell(12, TitleRow02).Value = "Project No.";
                _cells.GetCell(13, TitleRow02).Value = "Account Code";
                _cells.GetRange(10, TitleRow02, 13, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleRequired);

                _cells.GetCell(14, TitleRow02).Value = "Delivery Instructions"; //120 caracteres (60/60)
                _cells.GetCell(14, TitleRow02).AddComment("120 caracteres");
                _cells.GetCell(14, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(15, TitleRow02).Value = "Return Cause";
                _cells.GetCell(15, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleOptional);
                _cells.GetCell(16, TitleRow02).Value = "Issue Question";
                _cells.GetCell(16, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleOptional);

                var optionIssueList = new List<string> { "A - VENTAS", "B - RUBROS" };
                _cells.SetValidationList(_cells.GetCell(16, TitleRow02 + 1), optionIssueList, ValidationSheet, 4, false);

                _cells.GetCell(17, TitleRow02).Value = "Partial Allowed";
                _cells.GetCell(17, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleOptional);
                var partialAllowedList = new List<string> { "Y - YES", "N - No" };
                _cells.SetValidationList(_cells.GetCell(17, TitleRow02 + 1), partialAllowedList, ValidationSheet, 5, false);

                _cells.GetCell(18, TitleRow02).Value = "Stock Code";
                _cells.GetCell(18, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(19, TitleRow02).Value = "Unit Of Issue";
                _cells.GetCell(19, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleOptional);
                _cells.GetCell(20, TitleRow02).Value = "Quantity";
                _cells.GetCell(20, TitleRow02).Style = _cells.GetStyle(StyleConstants.TitleRequired);
                _cells.GetCell(ResultColumn02, TitleRow02).Value = "Result";
                ...
                _cells.FormatAsTable(_cells.GetRange(1, TitleRow02, ResultColumn02, TitleRow02 + 1), TableName01);
        ...
        private void CreateRequisitionService()
        {
            try
            {
                ...
                #region SortFields
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(1, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                            Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(2, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(3, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(4, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(5, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(6, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(7, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(8, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(9, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(10, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(11, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(12, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(13, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(14, TitleRow01), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                       ...
                       _cells.GetNullIfTrimmedEmpty(_cells.GetCell(3, currentRow).Value) != null)
                {
                    try
                    {
                        ...
                        else if (!prevReqHeader.Equals(curReqHeader) || (cbMaxItems.Checked && itemList.Count >= 99))
                        {
                            ...
                            foreach (var item in itemList)
                            {
                                try
                                {
                                    ...
                                    _cells.GetCell(ResultColumn01, currentRowHeader + item.Index).Value2 = "OK";
                                    _cells.GetCell(ResultColumn01, currentRowHeader + item.Index).Style = StyleConstants.Success;
                                ...
                                {
                                    _cells.GetCell(ResultColumn01, currentRowHeader + item.Index).Value2 += "ERROR: " + ex.Message;
                                    _cells.GetCell(ResultColumn01, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                ...
                                _cells.GetCell(ResultColumn01, currentRowHeader + item.Index).Select();
                            }
                            ...
                            if (abortRequisition && !_ignoreItemError)
                            {
                                ...
                                foreach (var item in itemList)
                                {
                                    ...
                                    _cells.GetCell(ResultColumn01, currentRowHeader + item.Index).Value2 += " - VALE ELIMINADO" + addMessage;
                                    _cells.GetCell(4, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                    _cells.GetCell(ResultColumn01, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                }
                            ...
                            else
                            {
                                ...
                                {
                                    _cells.GetCell(ResultColumn01, currentRow - 1).Value2 = _cells.GetCell(ResultColumn01, currentRow - 1).Value2 + " " + ex.Message;
                                    _cells.GetCell(ResultColumn01, currentRow-1).Style = StyleConstants.Warning;
                        ...
                        {
                            abortRequisition = true;
                            _cells.GetCell(ResultColumn01, currentRow).Value2 += curItem.StockCode + " NO EXISTE UNIDAD DE MEDIDA EN EL CATALOGO PARA ESTE STOCK CODE";
                        ...
                        if (odr.Read() && MyUtilities.IsTrue(odr["DIRECT_ORDER_IND"]))
                        {
                            ...
                            _cells.GetCell(ResultColumn01, currentRow).Value2 += curItem.StockCode + " ITEM DE ORDEN DIRECTA. DEBE CREAR EL VALE CON OTRO MÉTODO";
                            _cells.GetCell(ResultColumn01, currentRow).Style = StyleConstants.Error;
                            curItem.StockCode = "";//Se vacía el campo para conservar la estructura del vale, pero para que indique el error
                        }
                    ...
                    {
                        _cells.GetCell(ResultColumn01, currentRow).Value2 = ex.Message;
                        _cells.GetCell(ResultColumn01, currentRow).Style = StyleConstants.Error;
        ...
        private void CreateRequisitionServiceExtended()
        {
            try
            {
                if (_cells == null)
                    _cells = new ExcelStyleCells(_excelApp);
                _cells.SetCursorWait();
                _cells.ClearTableRangeColumn(TableName01, ResultColumn02);
                _cells.ClearTableRangeColumn(TableName01, 4);
                ...
                #region SortFields
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(1, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                            Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(2, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(3, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(4, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(5, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(6, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(7, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(8, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(9, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(10, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(11, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(12, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(13, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(14, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(15, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                _excelSheetItems.Sort.SortFields.Add(_cells.GetCell(16, TitleRow02), Excel.XlSortOn.xlSortOnValues,
                    Excel.XlOrder.xlDownThenOver, Type.Missing, Excel.XlSortDataOption.xlSortTextAsNumbers);
                       ...
                       _cells.GetNullIfTrimmedEmpty(_cells.GetCell(3, currentRow).Value) != null)
                {
                    try
                    {
                        ...
                        // ReSharper disable once SuggestVarOrType_BuiltInTypes
                        curReqHeader.WorkOrderA = _cells.GetNullOrTrimmedValue(_cells.GetCell(10, currentRow).Value);
                        curReqHeader.EquipmentA = _cells.GetNullOrTrimmedValue(_cells.GetCell(11, currentRow).Value);
                        curReqHeader.ProjectA = _cells.GetNullOrTrimmedValue(_cells.GetCell(12, currentRow).Value);
                        curReqHeader.CostCentreA = _cells.GetNullOrTrimmedValue(_cells.GetCell(13, currentRow).Value);

                        if(!string.IsNullOrWhiteSpace(curReqHeader.WorkOrderA))
                            curReqHeader.WorkProjectIndA = "W";//Solo aplica para MSO140
                        else if (!string.IsNullOrWhiteSpace(curReqHeader.ProjectA))
                            curReqHeader.WorkProjectIndA = "P"; //Solo aplica para MSO140

                        curReqHeader.ProtectedInd = false;
                        curReqHeader.ProtectedIndSpecified = false;
                        curReqHeader.DelivInstrA = _cells.GetEmptyIfNull(_cells.GetCell(14, currentRow).Value);
                        if (curReqHeader.DelivInstrA.Length > 80)
                            curReqHeader.DelivInstrB = curReqHeader.DelivInstrA.Substring(80);

                        curReqHeader.AnswerB = _cells.GetEmptyIfNull(_cells.GetCell(15, currentRow).Value).Length >= 2
                            ? _cells.GetEmptyIfNull(_cells.GetCell(15, currentRow).Value).Substring(0, 2).Trim()
                            : null;
                        curReqHeader.AnswerD = _cells.GetEmptyIfNull(_cells.GetCell(16, currentRow).Value).Length >= 2
                        ...
                        else if (!prevReqHeader.Equals(curReqHeader) || (cbMaxItems.Checked && itemList.Count >= 99))
                        {
                            ...
                            foreach (var item in itemList)
                            {
                                try
                                {
                                    ...
                                    proxyRequisition.createItem(opRequisition, itemRequest);
                                    _cells.GetCell(ResultColumn02, currentRowHeader + item.Index).Value2 = "OK";
                                    _cells.GetCell(ResultColumn02, currentRowHeader + item.Index).Style = StyleConstants.Success;
                                    _cells.GetCell(4, currentRowHeader + item.Index).Value2 = itemRequest.ireqNo;
                                    _cells.GetCell(4, currentRowHeader + item.Index).Style = StyleConstants.Success;
                                }
                                catch (Exception ex)
                                {
                                    _cells.GetCell(ResultColumn02, currentRowHeader + item.Index).Value2 += "ERROR: " + ex.Message;
                                    _cells.GetCell(ResultColumn02, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                    _cells.GetCell(4, currentRowHeader + item.Index).Value2 = prevReqHeader.IreqNo;
                                    _cells.GetCell(4, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                    abortRequisition = true;
                                }
                                _cells.GetCell(ResultColumn02, currentRowHeader + item.Index).Select();
                            }
                            ...
                            if (abortRequisition && !_ignoreItemError)
                            {
                                ...
                                {
                                    _cells.GetCell(4, currentRowHeader + item.Index).Value2 += " - ELIMINADO";
                                    _cells.GetCell(ResultColumn02, currentRowHeader + item.Index).Value2 += " - VALE ELIMINADO" + addMessage;
                                    _cells.GetCell(4, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                    _cells.GetCell(ResultColumn02, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                }
                            ...
                            else
                            {
                                ...
                                {
                                    _cells.GetCell(ResultColumn02, currentRow - 1).Value2 = _cells.GetCell(ResultColumn02, currentRow - 1).Value2 + " " + ex.Message;
                                    _cells.GetCell(ResultColumn02, currentRow - 1).Style = StyleConstants.Warning;
                                    _cells.GetCell(4, currentRow - 1).Style = StyleConstants.Warning;
                                }
                            }
                        ...
                        var curItem = new RequisitionItem
                        {
                            ...
                            PartIssueSpecified = true,
                            PartIssue =
                                MyUtilities.IsTrue(MyUtilities.GetCodeKey(_cells.GetNullIfTrimmedEmpty(_cells.GetCell(17, currentRow).Value)), true),
                            StockCode = _cells.GetNullOrTrimmedValue(_cells.GetCell(18, currentRow).Value)
                        };
                        curItem.StockCode = (curItem.StockCode != null && curItem.StockCode.Length < 9)
                            ? curItem.StockCode.PadLeft(9, '0')
                            : curItem.StockCode;
                        curItem.UnitOfMeasure = _cells.GetNullOrTrimmedValue(_cells.GetCell(19, currentRow).Value);
                        curItem.QuantityRequired = Convert.ToDecimal(_cells.GetCell(20, currentRow).Value);
                        ...
                        {
                            abortRequisition = true;
                            _cells.GetCell(ResultColumn02, currentRow).Value2 += curItem.StockCode + " NO EXISTE UNIDAD DE MEDIDA EN EL CATALOGO PARA ESTE STOCK CODE";
                            _cells.GetCell(ResultColumn02, currentRow).Style = StyleConstants.Error;
                            curItem.StockCode = "";//Se vacía el campo para conservar la estructura del vale, pero para que indique el error
                        }
                        ...
                        if (odr.Read() && MyUtilities.IsTrue(odr["DIRECT_ORDER_IND"]))
                        {
                            ...
                            _cells.GetCell(ResultColumn02, currentRow).Value2 += curItem.StockCode + " ITEM DE ORDEN DIRECTA. DEBE CREAR EL VALE CON OTRO MÉTODO";
                            _cells.GetCell(ResultColumn02, currentRow).Style = StyleConstants.Error;
                            curItem.StockCode = "";//Se vacía el campo para conservar la estructura del vale, pero para que indique el error
                        }
                    ...
                    {
                        _cells.GetCell(ResultColumn02, currentRow).Value2 = ex.Message;
                        _cells.GetCell(ResultColumn02, currentRow).Style = StyleConstants.Error;
                        _cells.GetCell(4, currentRow).Style = StyleConstants.Error;
                    }
                    finally
            ...
            try
            {
                ...
                while (_cells.GetNullIfTrimmedEmpty(_cells.GetCell(16, currentRow).Value) != null || _cells.GetNullIfTrimmedEmpty(_cells.GetCell(3, currentRow).Value) != null)
                {
                    try
                    {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                finally
                                {
                                    ...
                                    foreach (var item in itemList)
                                    {
                                        ...
                                        _cells.GetCell(ResultColumn01, currentRowHeader + item.Index).Value2 = addMessage;
                                        _cells.GetCell(4, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                        _cells.GetCell(ResultColumn01, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                    }
                                }
                        ...
                        {
                            _cells.GetCell(ResultColumn01, currentRow).Value2 +=
        ...
        private void CreateRequisitionScreenServiceExtended()
        {
            try
            {
                ...
                RequisitionHeader prevReqHeader = null;
                RequisitionHeader curReqHeader;
                while (_cells.GetNullIfTrimmedEmpty(_cells.GetCell(18, currentRow).Value) != null || _cells.GetNullIfTrimmedEmpty(_cells.GetCell(3, currentRow).Value) != null)
                {
                    try
                    {
                        //obtengo los datos para el encabezado
                        ...
                        if ((prevReqHeader != null && !prevReqHeader.Equals(curReqHeader) && itemList.Count > 0) || (cbMaxItems.Checked && itemList.Count >= 99))
                        {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                finally
                                {
                                    ...
                                    {
                                        _cells.GetCell(4, currentRowHeader + item.Index).Value2 = !string.IsNullOrWhiteSpace(prevReqHeader.IreqNo) ? prevReqHeader.IreqNo + " - ELIMINADO" : "";
                                        _cells.GetCell(ResultColumn02, currentRowHeader + item.Index).Value2 = addMessage;
                                        _cells.GetCell(4, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                        _cells.GetCell(ResultColumn02, currentRowHeader + item.Index).Style = StyleConstants.Error;
                                    }
                                }
                        ...
                        {
                            _cells.GetCell(ResultColumn02, currentRow).Value2 +=
                                "NO EXISTE UNIDAD DE MEDIDA EN EL CATALOGO PARA ESTE STOCK CODE";
                            _cells.GetCell(ResultColumn02, currentRow).Style = StyleConstants.Error;
                        }
                        _eFunctions.CloseConnection();
            ...
            try
            {
                       ...
                       _cells.GetNullIfTrimmedEmpty(_cells.GetCell(3, currentRow).Value) != null)
                {
                    ...
                    try
                    {
                        ...
                        if (result.errors.Length == 0)
                        {
                            _cells.GetCell(ResultColumn02, currentRow).Style = StyleConstants.Success;
                            _cells.GetCell(ResultColumn02, currentRow).Value2 = "OK";
                        }
                        else
                        {
                            _cells.GetCell(ResultColumn02, currentRow).Style = StyleConstants.Error;
                            foreach (var e in result.errors)
                            {
                                _cells.GetCell(ResultColumn02, currentRow).Value2 += " " + e.messageText;
                            }
                        }
                    ...
                    {
                        _cells.GetCell(ResultColumn02, currentRow).Value2 += "ERROR: " + ex.Message;
                        _cells.GetCell(ResultColumn02, currentRow).Style = StyleConstants.Error;
                        _cells.GetCell(4, currentRow).Style = StyleConstants.Error;
                    }
                    finally
