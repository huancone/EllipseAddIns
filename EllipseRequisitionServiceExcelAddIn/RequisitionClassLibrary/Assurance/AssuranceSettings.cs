...
namespace EllipseRequisitionServiceExcelAddIn.RequisitionClassLibrary.Assurance
{
    public static class AssuranceSettings
    {
        ...
        public static string DefaultLocalDataPath = SharedClassLibrary.Ellipse.Settings.CurrentSettings.DefaultLocalDataPath + @"addins\EllipseRequisitionServiceExcelAddin";
        ...
        public static Configuration UpdateSettings(Configuration c)
        {
            ...
            SharedClassLibrary.Utilities.FileWriter.CreateDirectory(path);
