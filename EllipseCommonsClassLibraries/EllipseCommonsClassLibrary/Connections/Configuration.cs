...
namespace EllipseCommonsClassLibrary.Connections
{
    ...
    {
        public const string DefaultRepositoryFilePath =
            @"\\lmnoas02\Shared\Sistemas\Mina\Proyecto Ellipse\Ellipse 8\ExcelAddIn_E8 (Loaders)\";
        ...
        public static bool IsServiceListForced
        {
            ...
            {
                var varForced =
                    "" + Environment.GetEnvironmentVariable(EllipseServicesForcedList, EnvironmentVariableTarget.User);
        ...
        public static string LocalDataPath
        {
            get
            {
                var varHome = "" + Environment.GetEnvironmentVariable(EllipseHomeEnvironmentVariable,
                                  EnvironmentVariableTarget.User);
            ...
            {
                var currentVar =
                    Environment.GetEnvironmentVariable(EllipseHomeEnvironmentVariable, EnvironmentVariableTarget.User);
                ...
                if (string.IsNullOrWhiteSpace(currentVar) && !value.Equals(DefaultLocalDataPath))
                    Environment.SetEnvironmentVariable(EllipseHomeEnvironmentVariable, value,
                        EnvironmentVariableTarget.User);
        ...
        public static string BackUpServiceFilePath
        {
            get
            {
                var varService = "" + Environment.GetEnvironmentVariable(EllipseSecondaryServicesEnvironmentVariable,
                                     EnvironmentVariableTarget.User);
            ...
            set
            {
                var currentVar = Environment.GetEnvironmentVariable(EllipseSecondaryServicesEnvironmentVariable,
                    EnvironmentVariableTarget.User);
                //no existe y es igual a _origen -> no hace nada
                ...
                //no existe y es diferente a _origen -> actualiza
                if (string.IsNullOrWhiteSpace(currentVar) && !value.Equals(SecondaryServiceFilePath))
                    Environment.SetEnvironmentVariable(EllipseSecondaryServicesEnvironmentVariable, value,
                        EnvironmentVariableTarget.User);
                //existe y es igual a environment -> no hace nada
                if (!string.IsNullOrWhiteSpace(currentVar) && value.Equals(currentVar))
                    return;
        ...
        public static string ServiceFilePath
        {
            get
            {
                var varService = "" + Environment.GetEnvironmentVariable(EllipseServicesEnvironmentVariable,
                                     EnvironmentVariableTarget.User);
                var varServiceExpanded = Environment.ExpandEnvironmentVariables(varService);
            ...
            set
            {
                var currentVar = Environment.GetEnvironmentVariable(EllipseServicesEnvironmentVariable,
                    EnvironmentVariableTarget.User);
                //no existe y es igual a _origen -> no hace nada
                ...
                //no existe y es diferente a _origen -> actualiza
                if (string.IsNullOrWhiteSpace(currentVar) && !value.Equals(DefaultServiceFilePath))
                    Environment.SetEnvironmentVariable(EllipseServicesEnvironmentVariable, value,
                        EnvironmentVariableTarget.User);
                //existe y es igual a environment -> no hace nada
                if (!string.IsNullOrWhiteSpace(currentVar) && value.Equals(currentVar))
                    return;
        ...
        public static void GenerateEllipseTnsnamesFile(string targetUrl)
        {
            ...
            {
                Debugger.LogError("GenerateEllipseTnsnamesFile",
                    "No se puede crear el archivo de configuración\n" + ex.Message);
                throw;
            }
        }
        ...
        public static void GenerateEllipseDatabaseFile()
        {
            ...
            databaseList.Add(
                new DatabaseItem("SIGCOPRD", "SIGCOPRD", "CONSULBO", "consulbo", "@DBLELLIPSE8", "ELLIPSE"));
