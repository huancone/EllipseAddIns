    ...
    public static class GroupConstants
    {
        public static List<WorkGroup> GetWorkGroupList()
        {
            var groupList = new List<WorkGroup>
            {
                ...
                new WorkGroup("ELIVIA1", "GRUPO DE TRABAJO DE EQUIPO LIVIANO", "SOP", "EQUIPO LIVIANO", "ICOR"),
                new WorkGroup("EMEDIA1", "GRUPO DE TRABAJO EQUIPO MEDIANO", "SOP", "EQUIPO MEDIANO", "ICOR"),
                ...
                new WorkGroup("PCSERVI", "PLANTA DE CARBON", "MDC", "MINA", "ICOR"),
