...
namespace EllipseCommonsClassLibrary.Utilities.RuntimeConfigSettings
{
    public class RuntimeConfigSettings
    {
        ...
        /// <summary>
        /// Adiciona un item especificado a la estructura raíz <rootnode><node keyname1=keyvalue1 keyname2=keyvalue2 /></rootnode>
        /// </summary>
        ...
        public static void AddNodeItem(string rootNode, string node, List<KeyValuePair<string, string>> keyList)
        {
            ...
            {
                nodeRegion.SetAttribute(key.Key, key.Value);
            }
        ...
        /// <param name="key">Parámetro KeyValuePair(name, value) con el valor a eliminar. Si value es nulo solo tomará en cuenta el keyName para la búsqueda</param>
        public static void DeleteNodeItem(string rootNode, string node, KeyValuePair<string, string> key)
        {
            ...
            XmlNode nodeItem = xmlDoc.SelectSingleNode(fullNode);
