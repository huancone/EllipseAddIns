                                ...
                                collection == ShiftConstants.ShiftCodes.DayNightCode) //dia 06-18 y noche de 18-06
                            {
                                ...
                                for (var j = 0; j < shiftArray.Length; j++)
                                {
                                    ...
                                    var dateString = TimeOperations.FormatDateToString(shiftArray[j].GetDate(),
                                        TimeOperations.DateTimeFormats.DateYYMMDD);
                                    var startTimeString =
                                        TimeOperations.FormatDateToString(shiftArray[j].GetStartDateTime().TimeOfDay,
                                            TimeOperations.DateTimeFormats.TimeHHMM);
                                    var endTimeString =
                                        TimeOperations.FormatDateToString(shiftArray[j].GetEndDateTime().TimeOfDay,
                                            TimeOperations.DateTimeFormats.TimeHHMM);
