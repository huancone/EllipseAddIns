...
namespace EllipseLabourCostingExcelAddIn.LabourEmployeeLibrary
{
    public static class LabourEmployeeActions
    {
        ...
        {
            using (var proxyLt = new LabourCostingTransService.LabourCostingTransService {Url = urlService + "/LabourCostingTrans"})
            {
                ...
                var requestLt = new LabourCostingTransDTO
                {
                    ...
                    labourCostingHours = !string.IsNullOrWhiteSpace(labourEmployee.LabourCostingHours) ? Convert.ToDecimal(labourEmployee.LabourCostingHours) : default,
                    labourCostingHoursSpecified = !string.IsNullOrEmpty(labourEmployee.LabourCostingHours),
                    labourCostingValue = !string.IsNullOrWhiteSpace(labourEmployee.LabourCostingValue) ? Convert.ToDecimal(labourEmployee.LabourCostingValue) : default,
                    ...
                    percentComplete = !string.IsNullOrWhiteSpace(labourEmployee.PercentComplete) ? Convert.ToDecimal(labourEmployee.PercentComplete) : default,
                    ...
                    unitsComplete = !string.IsNullOrWhiteSpace(labourEmployee.UnitsComplete) ? Convert.ToDecimal(labourEmployee.UnitsComplete) : default,
                ...
                if (replaceExisting)
                {
                    ...
                    if (replySearch != null && replySearch.Length >= 1)
                    {
                        foreach (var replyItem in replySearch)
                        {
                            ...
                            var itemTaskNo = string.IsNullOrWhiteSpace(replyItem.labourCostingTransDTO.workOrderTask) ? "000" : replyItem.labourCostingTransDTO.workOrderTask;
                ...
                var createResult = proxyLt.create(opContext, requestLt);
        ...
        /// <param name="autoTaskAssigment"></param>
        ...
        /// <param name="eFunctions">SharedClassLibrary.Ellipse.EllipseFunction</param>
        ...
        {
            //Proceso del screen
            using (var screenService = new Screen.ScreenService())
            {
                ...
                eFunctions.RevertOperation(opSheet, screenService);
                //ejecutamos el programa
                var replySheet = screenService.executeScreen(opSheet, "MSO850");
                ...
                replySheet = screenService.submit(opSheet, requestSheet);
