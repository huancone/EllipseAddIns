...
namespace SharedClassLibrary.Ellipse.Forms
{
    internal partial class SettingsBox : Form
    {
        ...
        private void SettingsBox_Load(object sender, EventArgs e)
        {
            ...
            var cultureInfo = MyUtilities.GetCultureInfo();
            
            cbCultureOptions.Items.Clear();
            cbCultureOptions.Items.Add(EllipseResources.DefaultCulture);
            cbCultureOptions.Items.Add(cultureInfo.Name);
            if (!cbCultureOptions.Items.Contains("en-US"))
                cbCultureOptions.Items.Add("en-US");
            if (!cbCultureOptions.Items.Contains("es-ES"))
                cbCultureOptions.Items.Add("es-ES");
            cbCultureOptions.SelectedItem = cultureInfo.Name;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            var selectedCulture = cbCultureOptions.SelectedItem.ToString();
            if (selectedCulture.Equals(EllipseResources.DefaultCulture))
                MyUtilities.SetCultureInfo(null);
            else
                MyUtilities.SetCultureInfo(selectedCulture);
        }
